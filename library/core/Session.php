<?php
    ...
    class Session{
        ...
        /**
         * Gets the value associated to the key in the session.
        ...
        /**
         * Checks if any value has been associated to the key in the session.
        ...
        /**
         * Destroys current session and deletes all keys and values.
         */
